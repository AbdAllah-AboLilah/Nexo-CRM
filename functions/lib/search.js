// ============================================================
//  تقطيع أسماء الأصناف لكلمات وبادئات للبحث
//
//  ليه موجود: فايرستور مابيعملش بحث "جوّه النص". فبنخزّن مع كل صنف
//  كل بادئات كلماته — يعني "موبايل" بتتخزّن كـ:
//     م / مو / موب / موبا / موباي / موبايل
//  وبنبحث بـ array-contains. النتيجة إن "موباي" تلاقي "موبايل"،
//  و"موبايل" تلاقي "شاشة موبايل".
//
//  التكلفة: الكتابة في فايرستور بتتحسب بالمستند مش بعدد عناصر
//  المصفوفة، فده مابيزوّدش تكلفة الكتابة. اللي بيزيد هو التخزين —
//  حوالي 1 كيلوبايت للصنف، يعني 50 ألف صنف ≈ 50 ميجا ≈ سنت في الشهر.
//
//  ⚠️ الملف ده لازم يفضل مطابق لـ js/search.js في المتصفح،
//     لأن الكلمات بتتكتب من الاتنين والبحث لازم يطابقها.
// ============================================================
...
function prefixesOf(word, out) {
  ...
  // الكلمة الطويلة بتتخزّن كاملة كمان عشان البحث بيها بالظبط يشتغل
...
module.exports = { normalize, tokenize, queryTokens, TOKEN_VERSION };
